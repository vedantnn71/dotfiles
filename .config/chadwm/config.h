...
static Key keys[] = {
    ...
    // { MODKEY|ControlMask,               XK_w,       spawn,          SHCMD("eww close eww") },
    // { MODKEY|ShiftMask,                 XK_w,       spawn,          SHCMD("eww open eww") },
    { MODKEY|ControlMask,               XK_f,       spawn,          SHCMD("st -c ranger") },
    { MODKEY|ControlMask,               XK_n,       spawn,          SHCMD("neovide Documents/scratchpad.md") },
    { MODKEY,                           XK_Return,  spawn,          SHCMD("kitty")},
    { MODKEY,                           XK_t,       spawn,          SHCMD("st -c tmux")},

    { MODKEY|ControlMask,               XK_e,       spawn,          SHCMD("rofi -show emoji") },
